    ...
    <div class="gal-header">
      <div class="gal-header-ornament">
        ...
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
          <path d="M6 0.5L7.06 3.9H10.6L7.77 5.98L8.83 9.38L6 7.3L3.17 9.38L4.23 5.98L1.4 3.9H4.94Z" fill="rgba(190,100,100,0.6)"/>
        </svg>
        <span class="gal-orn-line" />
      </div>
    ...
    <div class="gal-grid">
      ...
      >
        ...
        <img
          ...
          :alt="photo.caption"
          class="gal-img"
          :class="{ 'gal-img-ready': imgLoaded[idx] }"
          loading="eager"
        ...
        <div class="lb-image-wrap">
          ...
          <Transition name="lb-img-fade" mode="out-in">
            <img
              ...
              class="lb-img"
              :class="{ 'lb-img-ready': lightboxImgLoaded }"
              @load="lightboxImgLoaded = true"
            />
          </Transition>
        </div>
        ...
        <div class="lb-footer">
          ...
          <div class="lb-dots">
            <button
              ...
              :key="i"
              class="lb-dot"
              :class="{ 'lb-dot-active': i === activeIndex }"
              @click="activeIndex = i; lightboxImgLoaded = false"
