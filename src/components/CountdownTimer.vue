	...
	<section class="py-20 bg-gradient-to-b from-rose-50 via-white to-rose-50">
		<div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
			...
			<div v-if="!isWeddingDay"
				...
				]" :key="unit.label" class="flex flex-col items-center min-w-[70px] sm:min-w-[90px]">
					<div class="text-2xl sm:text-3xl font-semibold text-rose-700 bg-rose-50 rounded-2xl px-4 py-3 shadow-inner">
						{{ unit.value }}
					</div>
