...
<template>
	<div id="inv-stage"
		...
		<div class="relative flex items-center justify-center min-h-[420px] w-full max-w-lg px-6">
			...
			<!-- ── INVITATION CARD ── -->
			<div class="inv-card-wrap absolute inset-0 flex items-center justify-center px-6"
					...
					<div class="inv-card-inner">
						...
						<div class="inv-divider">
							...
							<svg width="14" height="14" viewBox="0 0 14 14" fill="none">
								<path d="M7 1L8.2 4.9H12.1L8.9 7.2L10.1 11.1L7 8.8L3.9 11.1L5.1 7.2L1.9 4.9H5.8Z"
